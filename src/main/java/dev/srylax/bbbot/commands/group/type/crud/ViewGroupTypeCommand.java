...
@Component
public class ViewGroupTypeCommand extends GroupTypeCommand {


    public ViewGroupTypeCommand(GatewayDiscordClient client, GroupTypeRepository groupTypeRepository) {
        super(client,groupTypeRepository,"view");
    }
